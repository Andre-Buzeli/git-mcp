...
exports.gitConfigTool = {
    ...
    async get(params) {
        try {
            ...
            const result = await (0, terminal_controller_js_1.runGitCommand)(gitCommand, params.projectPath, 'Obtendo configura̤̣o');
    ...
    async set(params) {
        try {
            ...
            const result = await (0, terminal_controller_js_1.runGitCommand)(gitCommand, params.projectPath, 'Definindo configura̤̣o');
            if (result.exitCode !== 0) {
    ...
    async unset(params) {
        try {
            ...
            const result = await (0, terminal_controller_js_1.runGitCommand)(gitCommand, params.projectPath, 'Removendo configura̤̣o');
            if (result.exitCode !== 0) {
    ...
    async list(params) {
        try {
            ...
            const result = await (0, terminal_controller_js_1.runGitCommand)(gitCommand, params.projectPath, 'Listando configura̵̤es');
            if (result.exitCode !== 0) {
    ...
    async edit(params) {
        try {
            ...
            const result = await (0, terminal_controller_js_1.runGitCommand)(gitCommand, params.projectPath, 'Editando configura̤̣o');
            if (result.exitCode !== 0) {
    ...
    async show(params) {
        try {
            ...
            const result = await (0, terminal_controller_js_1.runGitCommand)(gitCommand, params.projectPath, 'Mostrando configura̵̤es');
            if (result.exitCode !== 0) {
