...
exports.filesTool = {
    name: 'files',
    description: 'tool: Gerencia arquivos e diretórios (GitHub/Gitea)\n──────────────\naction get: obtém arquivo específico\naction get requires: repo, path, ref\n───────────────\naction create: cria novo arquivo\naction create requires: repo, path, content, message, branch\n───────────────\naction update: atualiza arquivo existente\naction update requires: repo, path, content, message, sha, branch\n───────────────\naction delete: remove arquivo\naction delete requires: repo, path, message, sha, branch\n───────────────\naction list: lista conteúdo de diretório\naction list requires: repo, path, ref, page, limit\n───────────────\naction search: busca arquivos por conteúdo\naction search requires: repo, query, ref',
    inputSchema: {
        type: 'object',
        properties: {
            action: {
