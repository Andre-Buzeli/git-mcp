...
exports.branchesTool = {
    name: 'branches',
    description: 'tool: Gerencia branches Git (GitHub/Gitea)\n──────────────\naction create: cria nova branch\naction create requires: repo, branch_name, from_branch\n───────────────\naction list: lista branches do repositório\naction list requires: repo, page, limit\n───────────────\naction get: obtém detalhes de branch\naction get requires: repo, branch\n───────────────\naction delete: remove branch\naction delete requires: repo, branch\n───────────────\naction merge: integra branches\naction merge requires: repo, head, base, merge_method\n───────────────\naction compare: compara branches\naction compare requires: repo, base_branch, head_branch',
    inputSchema: {
        type: 'object',
        properties: {
            action: {
