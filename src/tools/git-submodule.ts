...
const GitSubmoduleInputSchema = z.object({
  ...
  // Para add
  submodule_url: z.string().optional(),
  submodule_path: z.string().optional(),
  submodule_branch: z.string().optional(),
  
  // Para update/init/deinit
  submodule_name: z.string().optional(),
  ...
  // Para sync
  recursive_sync: z.boolean().optional(),
});

export type GitSubmoduleInput = z.infer<typeof GitSubmoduleInputSchema>;

const GitSubmoduleResultSchema = z.object({
  success: z.boolean(),
  action: z.string(),
  message: z.string(),
  data: z.any().optional(),
...
export const gitSubmoduleTool = {
  ...
  async handler(input: GitSubmoduleInput): Promise<GitSubmoduleResult> {
    try {
  ...
  async add(params: GitSubmoduleInput): Promise<GitSubmoduleResult> {
    try {
  ...
  async update(params: GitSubmoduleInput): Promise<GitSubmoduleResult> {
    try {
  ...
  async init(params: GitSubmoduleInput): Promise<GitSubmoduleResult> {
    try {
  ...
  async deinit(params: GitSubmoduleInput): Promise<GitSubmoduleResult> {
    try {
  ...
  async status(params: GitSubmoduleInput): Promise<GitSubmoduleResult> {
    try {
  ...
  async sync(params: GitSubmoduleInput): Promise<GitSubmoduleResult> {
    try {
