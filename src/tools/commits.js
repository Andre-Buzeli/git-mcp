...
exports.commitsTool = {
    name: 'commits',
    description: 'tool: Gerencia commits (GitHub/Gitea)\n──────────────\naction list: lista commits do repositório\naction list requires: repo, sha, page, limit\n───────────────\naction get: obtém detalhes de commit\naction get requires: repo, commit_sha\n───────────────\naction create: cria novo commit\naction create requires: repo, message, branch, author_name, author_email, committer_name, committer_email\n───────────────\naction compare: compara commits/branches\naction compare requires: repo, base, head\n───────────────\naction search: busca commits por critérios\naction search requires: repo, query, author, page, limit',
    inputSchema: {
        type: 'object',
        properties: {
            action: {
